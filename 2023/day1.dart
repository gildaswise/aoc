...
String parseWord(String value) {
  for (MapEntry entry in numberMap.entries) {
...
void main() {
  ...
  for (String word in input) {
    final parsedWord = parseWord(word);
    final onlyNumbers = parsedWord
        .split('')
    ...
    final sum = '${onlyNumbers.first}' + '${onlyNumbers.last}';
    print("sum for $word (parsed: $parsedWord) is $sum");
    count += int.parse(sum);
  }
  print(count);
}
